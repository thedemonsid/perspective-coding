...
<BlockQuote>
  The first message sent over the Internet's predecessor (ARPANET) was supposed
  to be "LOGIN" but the system crashed after "LO"!

  </BlockQuote>
  <BlockQuote>
    There are enough underwater
  Internet cables to circle the Earth 8 times India has over 700 million
  Internet users - that's more than twice the population of America!
</BlockQuote>
## 🎮 Challenge Time!
...
<Quizcomponent
  question={"What is the fastest way to connect to internet"}
  options={["Wifi", "Ethernet", "Bluetooth", "Mobile Data"]}
  answer={"Ethernet"}
/>
...
Design your own "Internet of the Future"! describe what you think the Internet will be like in 2050. Will we have holograms? Brain-computer interfaces? Share your creative ideas!
